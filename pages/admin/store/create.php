...
<div class="wrap">
	...
	<form method="POST" action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>" id="newstore_form">
		...
		<table>
		<!-- Location/Name -->
		<tr><td>Store Location/Name</td><td><input type="text" name="wpsqt_store_location"/></td></tr>
		<!-- State -->
		<tr><td>State</td><td><?php echo Wpsqt_System::getStateDropdown("wpsqt_store_state",$state); ?></td></tr>
